...
class getbacklog(object):
        ...
        for data in backlogdata:
            ...
            if data[-1] == '1' and data[-3] == 'Partially_Cancelled':
                ...
                if data[7] not in fillresult:
                    ...
                    fillresult[data[7]][2] = int(data[11])
            ...
            if data[-1] == '2':
                ...
                if data[7] not in fillresult:
                    ...
                    fillresult[data[7]][1] += int(data[10])
    ...
    def search_doing(self):
        ...
        for line in remote_file:
            listdata = line.strip().split()
            if listdata[-1] in ['Partially_Filled','Pending_Dealing',"Partially_Pending_Cancel","Pending_Cancel"]:
